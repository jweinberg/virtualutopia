...
//Move Form I
inline void CPU::v810::move(uint8_t reg1, uint8_t reg2)
{
...
//Move Form II
inline void CPU::v810::moveImmediate(uint8_t imm5, uint8_t reg2)
{
...
//Add Form I
inline void CPU::v810::add(uint8_t reg1, uint8_t reg2)
{
...
//Add Form II
inline void CPU::v810::addImmediate5(uint8_t imm5, uint8_t reg2)
{
...
inline void CPU::v810::addImmediate(uint8_t reg1, uint8_t reg2, int16_t imm16)
{
...
//Subtract
inline void CPU::v810::subtract(uint8_t reg1, uint8_t reg2)
{
...
inline void CPU::v810::divide(uint8_t reg1, uint8_t reg2)
{
...
inline void CPU::v810::divideUnsigned(uint8_t reg1, uint8_t reg2)
{
...
inline void CPU::v810::multiply(uint8_t reg1, uint8_t reg2)
{
...
inline void CPU::v810::multiplyUnsigned(uint8_t reg1, uint8_t reg2)
{
...
//Compare Form I
inline void CPU::v810::compare(uint8_t reg1, uint8_t reg2)
{
    uint32_t a = generalRegisters[reg1];
    uint32_t b = generalRegisters[reg2];
...
//Compare Form II
inline void CPU::v810::compareImmediate(uint8_t imm5, uint8_t reg2)
{
    int32_t a = sign_extend<5>(imm5);
    int32_t b = generalRegisters[reg2];
...
//Set Flag Condition
inline void CPU::v810::setFlag(uint8_t imm5, uint8_t reg2)
{
...
//Shift Left Form I
inline void CPU::v810::shiftLeft(uint8_t reg1, uint8_t reg2)
{
...
//Shift Left Form II
inline void CPU::v810::shiftLeftImmediate(uint8_t imm5, uint8_t reg2)
{
...
//Shift Right Form I
inline void CPU::v810::shiftRight(uint8_t reg1, uint8_t reg2)
{
...
//Shift Right Form II
inline void CPU::v810::shiftRightImmediate(uint8_t imm5, uint8_t reg2)
{
...
inline void CPU::v810::shiftArithmeticRight(uint8_t reg1, uint8_t reg2)
{
...
inline void CPU::v810::shiftArithmeticRightImmediate(uint8_t imm5, uint8_t reg2)
{
...
inline void CPU::v810::logicalOr(uint8_t reg1, uint8_t reg2)
{
...
inline void CPU::v810::logicalXor(uint8_t reg1, uint8_t reg2)
{
...
inline void CPU::v810::logicalAnd(uint8_t reg1, uint8_t reg2)
{
...
inline void CPU::v810::logicalNot(uint8_t reg1, uint8_t reg2)
{
...
inline void CPU::v810::andImmediate(uint8_t reg1, uint8_t reg2, uint16_t imm16)
{
...
inline void CPU::v810::orImmediate(uint8_t reg1, uint8_t reg2, uint16_t imm16)
{
...
inline void CPU::v810::xorImmediate(uint8_t reg1, uint8_t reg2, uint16_t imm16)
{
...
inline void CPU::v810::jump(uint8_t reg1, uint8_t unused)
{
...
inline void CPU::v810::jumpRelative(uint32_t disp26)
{
...
inline void CPU::v810::branchIfNoOverflow(uint16_t disp9)
{
    d_printf("%s\n", "BNV");
...
inline void CPU::v810::branchIfOverflow(uint16_t disp9)
{
    d_printf("%s\n", "BV");
...
inline void CPU::v810::branchIfZero(uint16_t disp9)
{
    d_printf("%s\n", "BZ");
...
inline void CPU::v810::branchIfNotZero(uint16_t disp9)
{
    d_printf("%s\n", "BNZ");
...
inline void CPU::v810::branchIfLessThan(uint16_t disp9)
{
    d_printf("%s\n", "BLT");
...
inline void CPU::v810::branchIfNotHigher(uint16_t disp9)
{
    d_printf("%s\n", "BNH");
...
inline void CPU::v810::branchIfNegative(uint16_t disp9)
{
    d_printf("%s\n", "BN");
...
inline void CPU::v810::branchIfPositive(uint16_t disp9)
{
    d_printf("%s\n", "BP");
...
inline void CPU::v810::branchIfHigher(uint16_t disp9)
{
    d_printf("%s\n", "BH");
...
inline void CPU::v810::branchIfGreaterOrEqual(uint16_t disp9)
{
    d_printf("BGE\n");
...
inline void CPU::v810::branchIfGreaterThan(uint16_t disp9)
{
    d_printf("BGT\n");
...
inline void CPU::v810::branchIfLessOrEqual(uint16_t disp9)
{
    d_printf("BLE\n");
...
inline void CPU::v810::nop(uint16_t disp9)
{
    d_printf("NOP\n");
    programCounter += 2;
    cycles += 1;
...
inline void CPU::v810::branchIfCarry(uint16_t disp9)
{
    d_printf("BC\n");
...
inline void CPU::v810::branchIfNoCarry(uint16_t disp9)
{
    d_printf("BNC\n");
...
inline void CPU::v810::branch(uint16_t disp9)
{
    d_printf("BR\n");
    programCounter += sign_extend<9>(disp9);
    cycles += 3;
...
inline void CPU::v810::moveHigh(uint8_t reg1, uint8_t reg2, uint16_t imm16)
{
...
inline void CPU::v810::moveAddImmediate(uint8_t reg1, uint8_t reg2, uint16_t imm16)
{
...
inline void CPU::v810::storeWord(uint8_t reg1, uint8_t reg2, uint16_t disp16)
{
...
inline void CPU::v810::storeHWord(uint8_t reg1, uint8_t reg2, uint16_t disp16)
{
...
inline void CPU::v810::storeByte(uint8_t reg1, uint8_t reg2, uint16_t disp16)
{
...
inline void CPU::v810::outWord(uint8_t reg1, uint8_t reg2, uint16_t disp16)
{
    uint32_t address = (generalRegisters[reg1] + (int16_t)disp16) & 0xFFFFFFFC;
...
inline void CPU::v810::outHWord(uint8_t reg1, uint8_t reg2, uint16_t disp16)
{
    uint32_t address = (generalRegisters[reg1] + (int16_t)disp16) & 0xFFFFFFFE;
...
inline void CPU::v810::outByte(uint8_t reg1, uint8_t reg2, uint16_t disp16)
{
    uint32_t address = (generalRegisters[reg1] + (int16_t)disp16);
...
inline void CPU::v810::loadByte(uint8_t reg1, uint8_t reg2, uint16_t disp16)
{
...
inline void CPU::v810::loadHWord(uint8_t reg1, uint8_t reg2, uint16_t disp16)
{
    uint32_t address = (generalRegisters[reg1] + (int16_t)disp16);
    address &= 0xFFFFFFFE;
...
inline void CPU::v810::loadWord(uint8_t reg1, uint8_t reg2, uint16_t disp16)
{
    uint32_t address = (generalRegisters[reg1] + (int16_t)disp16) & 0xFFFFFFFC;
...
inline void CPU::v810::inByte(uint8_t reg1, uint8_t reg2, uint16_t disp16)
{
...
inline void CPU::v810::inHWord(uint8_t reg1, uint8_t reg2, uint16_t disp16)
{
    uint32_t address = (generalRegisters[reg1] + (int16_t)disp16);
    address &= 0xFFFFFFFE;
...
inline void CPU::v810::inWord(uint8_t reg1, uint8_t reg2, uint16_t disp16)
{
    uint32_t address = (generalRegisters[reg1] + (int16_t)disp16) & 0xFFFFFFFC;
...
inline void CPU::v810::loadSystemRegister(uint8_t reg1, uint8_t reg2)
{
    d_printf("LDSR %d\n", reg1);
...
inline void CPU::v810::storeSystemRegister(uint8_t reg1, uint8_t reg2)
{
    d_printf("STSR %d\n", reg1);
...
inline void CPU::v810::jumpAndLink(uint32_t disp26)
{
    d_printf("JAL\n");
#if VIRTUAL_PC
...
inline void CPU::v810::outWrite(uint8_t reg1, uint8_t reg2, uint16_t disp16)
{
    d_printf("OUT.W\n");
    programCounter += 4;
}

inline void CPU::v810::setInterruptDisable(uint8_t reg1, uint8_t reg2)
{
    d_printf("SEI\n");
...
inline void CPU::v810::clearInterruptDisable(uint8_t reg1, uint8_t reg2)
{
    d_printf("CLI\n");
...
inline void CPU::v810::returnFromTrap(uint8_t imm5, uint8_t reg2)
{
    d_printf("RETI\n");
...
inline void CPU::v810::compareFloat(uint8_t reg1, uint8_t reg2)
{
    d_printf("CMPF.S\n");
...
inline void CPU::v810::convertWordToFloat(uint8_t reg1, uint8_t reg2)
{
    d_printf("CVT.WS\n");
...
inline void CPU::v810::convertFloatToWord(uint8_t reg1, uint8_t reg2)
{
    d_printf("CVT.SW\n");
...
inline void CPU::v810::addFloat(uint8_t reg1, uint8_t reg2)
{
    d_printf("ADDF.S\n");
...
inline void CPU::v810::subtractFloat(uint8_t reg1, uint8_t reg2)
{
    d_printf("SUBF.S\n");
...
inline void CPU::v810::multiplyFloat(uint8_t reg1, uint8_t reg2)
{
    d_printf("MULF.S\n");
...
inline void CPU::v810::divideFloat(uint8_t reg1, uint8_t reg2)
{
    d_printf("DIVF.S\n");
...
inline void CPU::v810::truncateFloat(uint8_t reg1, uint8_t reg2)
{
    d_printf("TRNC.SW\n");
    float f = generalRegistersFloat[reg1];
    int32_t t = 0;
...
inline void CPU::v810::exchangeByte(uint8_t reg1, uint8_t reg2)
{
    d_printf("XB\n");
...
inline void CPU::v810::exchangeHalfWord(uint8_t reg1, uint8_t reg2)
{
    d_printf("XH\n");
    int32_t val = generalRegisters[reg2];
...
inline void CPU::v810::reverseWord(uint8_t reg1, uint8_t reg2)
{
    d_printf("REV\n");
...
inline void CPU::v810::multiplyHalfWord(uint8_t reg1, uint8_t reg2)
{
    d_printf("MPYHW\n");
...
inline void CPU::v810::moveBitString(uint8_t reg1, uint8_t reg2)
{
    d_printf("MOVBSU\n");
...
inline void CPU::v810::andBitString(uint8_t reg1, uint8_t reg2)
{
    d_printf("ANDBSU\n");
...
inline void CPU::v810::orBitString(uint8_t reg1, uint8_t reg2)
{
    d_printf("ORBSU\n");
    uint32_t startAddress = generalRegisters[30];
    uint32_t destAddress = generalRegisters[29];
...
inline void CPU::v810::xorBitString(uint8_t reg1, uint8_t reg2)
{
    d_printf("XORBSU\n");
    uint32_t startAddress = generalRegisters[30];
    uint32_t destAddress = generalRegisters[29];
...
inline void CPU::v810::andNotBitString(uint8_t reg1, uint8_t reg2)
{
    d_printf("ANDNBSU\n");
    uint32_t startAddress = generalRegisters[30];
    uint32_t destAddress = generalRegisters[29];
...
inline void CPU::v810::orNotBitString(uint8_t reg1, uint8_t reg2)
{
    d_printf("ORNBSU\n");
    uint32_t startAddress = generalRegisters[30];
    uint32_t destAddress = generalRegisters[29];
...
inline void CPU::v810::xorNotBitString(uint8_t reg1, uint8_t reg2)
{
    d_printf("XORNBSU\n");
    uint32_t startAddress = generalRegisters[30];
    uint32_t destAddress = generalRegisters[29];
...
inline void CPU::v810::notBitString(uint8_t reg1, uint8_t reg2)
{
    d_printf("XORNBSU\n");
    uint32_t startAddress = generalRegisters[30];
    uint32_t destAddress = generalRegisters[29];
